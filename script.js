 ...
 fetch('data/events.json')
  ...
  .then(eventos => {
    ...
    eventosFuturos.forEach(evento => {
      ...
      card.innerHTML = `
        <div class="agenda-card-columns">
          <div class="agenda-date-col">
            <span class="agenda-date-number">${dia}</span>
            <span class="agenda-date-month">${mes}</span>
          </div>
          <div class="agenda-card-content">
            <a href="${evento.enlace}" class="agenda-title">${evento.titulo}</a>
            <span class="agenda-category">
              <span class="agenda-category-icon">
...
fetch('data/events.json')
  ...
  .then(eventos => {
    ...
    eventosFuturos.forEach(evento => {
      ...
      item.className = 'agenda-list-item';

      item.innerHTML = ` 
        <div class="agenda-list-date">
          <span class="agenda-list-day">${dia}</span>
          <span class="agenda-list-month">${mes}</span>
        </div>
        ...
        <div class="agenda-list-content">
          ...
          <div class="agenda-list-description">
            ${evento.descripcion}
          </div>
        </div>
      `;
    ...
    const items = document.querySelectorAll('.agenda-list-item');
